...
if __name__ == '__main__':
    ...
    for i in range(3):
        ...
        #the number 2 is link2 which is the server2
        #sample message that is 80 characters long
        client.udt_send(2, 'This is Sample data #%d that is eighty characters long. The quick brown fox jumps over '
                           'the lazy dog' % i)
